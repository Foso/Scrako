...
private  class SetVariable(private val variable: ScratchVariable, private val item: String) : Node {
    override fun visit(
...
fun NodeBuilder.setVariable(variable: ScratchVariable, item: String) = addChild(SetVariable(variable, item))
