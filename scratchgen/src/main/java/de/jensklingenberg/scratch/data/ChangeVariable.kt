...
private class ChangeVariable(private val variable: ScratchVariable, private val item: Int) : Node {
    override fun visit(
...
fun NodeBuilder.changeVariable(variable: ScratchVariable, item: Int) = addChild(ChangeVariable(variable, item))