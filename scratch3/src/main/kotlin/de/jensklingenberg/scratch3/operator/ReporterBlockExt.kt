...
infix fun ReporterBlock.eq(reporterBlock: ReporterBlock): BooleanBlock {
    return OperatorEquals(this, reporterBlock)
}
...
infix fun ReporterBlock.minus(booleanBlock: ReporterBlock): ReporterBlock {
...
infix fun BooleanBlock.or(reporterBlock: BooleanBlock): BooleanBlock {
    return OperatorOr(this, reporterBlock)
}
