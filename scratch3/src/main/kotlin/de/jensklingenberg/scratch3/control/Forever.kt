...
fun StageScriptBuilder.forever(block: CommonScriptBuilder.() -> Unit) =
    addNode(Forever(StageScriptBuilder().apply(block).getNodes()))

fun SpriteScriptBuilder.forever(block: CommonScriptBuilder.() -> Unit) =
    addNode(Forever(SpriteScriptBuilder().apply(block).getNodes()))
