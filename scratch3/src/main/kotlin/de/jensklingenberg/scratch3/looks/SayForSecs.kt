...
private class SayForSecs(
    ...
    override fun visit(
        ...
        visitors[identifier] = BlockSpec(
            ...
            inputs = mapOf(
                "MESSAGE" to setValue(message, messageId, context),
...
fun SpriteScriptBuilder.sayForSecs(message: String, secs: ReporterBlock) =
    addNode(SayForSecs(StringBlock(message), secs))

fun SpriteScriptBuilder.sayForSecs(message: Int, secs: ReporterBlock) = addNode(SayForSecs(IntBlock(message), secs))
fun SpriteScriptBuilder.sayForSecs(message: Double, secs: ReporterBlock) =
    addNode(SayForSecs(DoubleBlock(message), secs))
